              ...
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                ...
                ?>
                  <label class="btn btn-secondary">
                    <input name="wall_type" data-wall-id="<?php echo $type['id']; ?>" class="wallType" type="radio" data-base-index="
                    <?php echo $type['green_index']; ?>" autocomplete="off">
                    <span class="wall-item">
                    <?php echo $type['icon'] ? '<img src="data:image/jpeg;base64,' . base64_encode( $type['icon'] ) . '"/>' : ''; ?>
                    </span>
                    <?php echo $type['name']; ?>
                  </label>
                <?php
